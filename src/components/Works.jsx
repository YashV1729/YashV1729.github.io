        ...
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex flex-col justify-end m-3 card-img_hover">
            <div
              ...
              className="white-gradient w-12 h-12 rounded-full flex justify-center items-center cursor-pointer"
            >
              <img
                src={github}
                alt="source code"
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          These are my personl projects which showcases the technical skills through
